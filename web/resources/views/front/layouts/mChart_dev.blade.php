...
<script type="text/javascript">
    ...
    function setNewOption(data) {
        ...
        var dataMA5 = calculateMA(5, data.values);
        var dataMA10 = calculateMA(10, data.values);
        var dataMA20 = calculateMA(20, data.values);
        myChart.setOption(
            {
                animation: false,
                color: colorList,
                ...
                xAxis: [{
                    ...
                    axisLabel: {
                        formatter: function (value) {
                            if(echarts.format.formatTime('MM-dd', value) == 'nan-NaN') {
                                return value;
                            }
                            return echarts.format.formatTime('MM-dd', value);
                        }
