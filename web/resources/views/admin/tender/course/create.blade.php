        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <form class="form-horizontal" action="{{route('tender/course/create')}}" role="form" method="post" novalidate enctype="multipart/form-data">
                    {{csrf_field()}}
                    {!! Form::bsText(['label' => '名称', 'name' => 'name', 'value' => old('name'), 'placeholder' => "请输入课程名称", 'ext'=>'required']) !!}
                    {!! Form::bsText(['label' => '课程摘要', 'name' => 'summary', 'value' => old('summary'), 'placeholder' => "请输入课程摘要", 'ext'=>'required']) !!}

                    {!! Form::bsText(['label' => '课程视频', 'name' => 'video', 'value' => old('video'), 'placeholder' => "请输入视频地址", 'ext'=>'required']) !!}
                    {!! Form::bsText(['label' => '视频截图', 'name' => 'poster', 'value'=>old('poster'), 'placeholder' => '请输入视频截图地址', 'ext' => 'required']) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <div class="col-md-1">
                                <label class="check"><input name="stat" value="1" type="radio" class="iradio"/> 是</label>
                            </div>
                            <div class="col-md-1">
                                <label class="check"><input name="stat" value="0" type="radio" class="iradio" checked="checked"/> 否</label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
