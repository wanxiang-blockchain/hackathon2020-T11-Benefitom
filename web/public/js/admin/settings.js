var site_settings = '<div class="ts-button">'
    ...
    +'<div class="ts-body">'
        ...
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_fixed" value="1" checked/> 固定边侧</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_scroll" value="1"/> 滚动边侧</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_right" value="1"/> 边侧放右边</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_custom" value="1"/> 自定义菜单</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_toggled" value="1"/> 响应式菜单</label>'
        +'</div>'
        +'<div class="ts-title">展示</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="radio" class="iradio" name="st_layout_boxed" value="0" checked/> 全宽</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="radio" class="iradio" name="st_layout_boxed" value="1"/> 盒子</label>'
        +'</div>'
        +'<div class="ts-title">主题</div>'
        +'<div class="ts-themes">'
            +'<a href="#" class="active" data-theme="/css/admin/theme-default.css"><img src="/img/admin/themes/default.jpg"/></a>'
            +'<a href="#" data-theme="/css/admin/theme-forest.css"><img src="/img/admin/themes/forest.jpg"/></a>'
            +'<a href="#" data-theme="/css/admin/theme-dark.css"><img src="/img/admin/themes/dark.jpg"/></a>'
            +'<a href="#" data-theme="/css/admin/theme-night.css"><img src="/img/admin/themes/night.jpg"/></a>'
            +'<a href="#" data-theme="/css/admin/theme-serenity.css"><img src="/img/admin/themes/serenity.jpg"/></a>'

            +'<a href="#" data-theme="/css/admin/theme-default-head-light.css"><img src="/img/admin/themes/default-head-light.jpg"/></a>'
            +'<a href="#" data-theme="/css/admin/theme-forest-head-light.css"><img src="/img/admin/themes/forest-head-light.jpg"/></a>'
            +'<a href="#" data-theme="/css/admin/theme-dark-head-light.css"><img src="/img/admin/themes/dark-head-light.jpg"/></a>'
            +'<a href="#" data-theme="/css/admin/theme-night-head-light.css"><img src="/img/admin/themes/night-head-light.jpg"/></a>'
            +'<a href="#" data-theme="/css/admin/theme-serenity-head-light.css"><img src="/img/admin/themes/serenity-head-light.jpg"/></a>'
